...
<div key={item.id} style={{display:"flex",alignItems:"center",justifyContent:"space-between",border:"1px solid #ddd",padding:20,margin:"20px 0"}}>
...
<button onClick={()=>remove(item.id)} style={{marginLeft:15,color:"red"}}>Delete</button>
